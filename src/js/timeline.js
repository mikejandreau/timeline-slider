jQuery(document).ready(function($){
	...
	function translateTimeline(timelineComponents, value, totWidth) {
		...
		var undefinedWidth = (typeof totWidth === 'undefined'); // set this as variable to avoid !not confusion
		value = (value > 0) ? 0 : value; // only negative translate value
		value = ( !undefinedWidth && value < totWidth ) ? totWidth : value; // do not translate more than timeline width
